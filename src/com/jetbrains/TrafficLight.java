...
public class TrafficLight {
    private static final double CHANGE_GREEN = 0.5; //the probability of red light and green light is equal
    ...
    public TrafficLight(String id, Road road) {
        ...
        position = this.roadAttachedTo.getLength(); // traffic light at the end of the road
